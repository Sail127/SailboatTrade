...
export async function notifyOwnerListingPublished({
  ...
  try {
    ...
    await sendEmail({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; line-height: 1.5;">
          <h2 style="margin: 0 0 10px;">Congratulations, your listing is live</h2>
          <p style="margin: 0 0 8px;">Hi ${ownerNameSafe},</p>
          <p style="margin: 0 0 8px;">
            Great news - your listing <strong>${listingTitleSafe}</strong> has been approved and is now live on SailboatTrade.
          </p>
          <p style="margin: 0 0 12px;"><strong>Listing ID:</strong> ${listingIdSafe}</p>
          <p style="margin: 12px 0 8px;">
            <a href="${listingUrlSafe}" style="display:inline-block;background:#0a2230;color:#ffffff;padding:10px 14px;border-radius:10px;text-decoration:none;font-weight:700;">
          ...
          <p style="margin: 0;">
            <a href="${editUrlSafe}" style="color:#1d4ed8;text-decoration:underline;">Edit listing</a>
          </p>
          <p style="margin: 12px 0 0;color:#64748b;font-size:12px;">Source: ${sourceSafe}</p>
        </div>
      `,
      text: `Congratulations, your listing is live

Hi ${ownerName},

Great news - your listing ${listingTitle} has been approved and is now live on SailboatTrade.
