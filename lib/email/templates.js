...
function siteAssets(appUrl) {
  ...
  return {
    ...
    heroUrl: `${base}/hero-sailboat-welcome.jpg`,
  };
}
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="sbt-shell" style="max-width:640px;background:${BRAND.white};border-radius:28px;overflow:hidden;border:1px solid #dbe5ea;box-shadow:0 18px 40px rgba(10,34,48,.12);">
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      ...
                      <table role="presentation" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td style="vertical-align:middle;">
                            ...
                            <div style="font-size:12px;color:#d7e3ea;">All Sailboats, All the Time!</div>
                          </td>
                        </tr>
                      </table>
                    </td>
                  ...
                  <tr>
                    <td style="padding:0 0 24px;">
                      ...
                      <p style="margin:0;max-width:520px;font-size:15px;line-height:1.65;color:#dce8ee;">${esc(intro)}</p>
                      ${headerPrimary}
                    </td>
                  </tr>
                </table>
            ...
            <tr>
              <td class="sbt-pad" style="padding:0 24px;">
                <div style="margin:-8px 0 0;border:1px solid #d9c486;border-radius:22px;overflow:hidden;background:linear-gradient(90deg,#fffdf8 0%,#fff4d7 100%);box-shadow:0 16px 30px rgba(10,34,48,.08);">
                  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="sbt-stack">
                    <tr>
                      <td width="40%" style="padding:0;">
                        <img src="${esc(assets.heroUrl)}" alt="Sailboat on the water" class="sbt-fluid-image" style="display:block;width:100%;max-width:100%;height:auto;border:0;" />
                      </td>
                      <td class="sbt-pad" style="padding:24px 22px;">
...
export function buildVerifyEmailMessage({
  ...
  return createMessage({
    ...
    preheader: "Confirm your email to activate posting privileges and secure your account.",
    eyebrow: isResend ? "Verification Reminder" : "Welcome Aboard",
    headline: isResend ? `Verify your email, ${who}` : `Welcome aboard, ${who}`,
    intro: "Your account is almost ready. Verify your email to unlock listing creation and keep your SailboatTrade account protected.",
    heroTitle: "Confirm your email and start listing with confidence.",
    heroBody: "We require a verified email before a new listing can be posted. It is a simple step that helps protect both buyers and sellers.",
    sections: [
      sectionBlock({
        label: "What happens next",
        body: "Click the button below to confirm your email address. Once verified, your account can create listings, manage saved boats, and use dashboard features without interruption.",
        tone: "gold",
      }),
      sectionBlock({
